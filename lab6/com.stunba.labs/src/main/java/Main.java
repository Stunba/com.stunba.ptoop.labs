...
public class Main {
    public static void main(String [] args) {
        ...
        try {
            // try to load plugin
            File dir = new File("/Users/abastun/Projects/ptoop/lab6/com.stunba.labs/com.stunba.labs.plugin/out/production/classes");
            URL loadPath = dir.toURI().toURL();
            URL[] classUrl = new URL[]{loadPath};

            ClassLoader cl = new URLClassLoader(classUrl);

            Class loadedClass = cl.loadClass("AnotherPluginAdapter");
            ...
            byte[] decoded = coder.decode(loaded);
            ByteArrayInputStream stream = new ByteArrayInputStream(decoded);
            ObjectInputStream in = new MyInputObjectStream(stream);
